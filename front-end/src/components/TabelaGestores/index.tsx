...
import { ResponseAdminApi } from "../../types";
import Checkbox from "@mui/material/Checkbox";
import CircularProgress from "@mui/material/CircularProgress";

function TabelaGestores({
  gestores,
}: {
  gestores: readonly ResponseAdminApi[];
}) {
  const statusMap = {
  ...
  return (
    <>
      {gestores.length === 0 ? (
        <CircularProgress
          style={{ margin: "2% auto", width: 100, height: 100 }}
        />
      ) : (
                ...
                .map((gestor) => {
                  ...
                  return (
                    <TableRow hover key={gestor.idProjeto}>
                      ...
                      <TableCell>
                        <Checkbox checked={gestor.GestorId ? true : false} />
                      </TableCell>
                    </TableRow>
                  );
                })}
